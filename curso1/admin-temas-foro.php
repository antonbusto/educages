...
$nome="administracion de temas del foro";
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
echo "<h4 class='text-center'><strong>Administraci&oacute;n de temas del foro</strong></h4>";

//se arma la consulta para los usuarios del curso
$sql="SELECT * 
	  FROM curso" . $_SESSION['curso'] . "_foro_temas";
...
echo "<p><a href='crear-tema.php' title='Crear tema' class='btn btn-success'>Crear nuevo tema</a></p>";
...
echo "<table class='table table-striped'>
	   ...
	   usando el bucle do para presentar el primer registro */
		...
		<tr>
		<td>" . $fila['id_tema'] . "</td>
		<td>" . htmlentities($fila['asunto_tema']) . "</td>
		<td>" . $fila['data_tema'] . "</td>
		<td>" . $fila['categoria_tema'] . "</td>
		<td>" . $fila['por_tema'] . "</td>
		<td><a href='modificar-tema-foro.php?id=" . $fila['id_tema'] . "' title='Modificar' class='btn btn-success'>Modificar</a></td>
		<td><a href='eliminar-tema-foro.php?id=" . $fila['id_tema'] . "' title='Borrar' class='btn btn-danger'>Borrar</a>
		</tr>";
...
echo"
	<tr><td colspan='6' class='dereita'><strong>Total temas:</strong></td><td><span class='badge badge-secondary'>" . $total_filas . "</span></td></tr>
	</table> </div>";
