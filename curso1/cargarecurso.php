...
$nome="Carga de recursos para alumnos";
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<?php 
 ...
 $destino= getcwd() . "/descargas/recursos/";
 ...
 si la transferencia es correcta se informa al usuario */
  ...
  echo "<p class='text-center'><a href='recursos.php'>Volver</a></p>";
  }
  ...
  echo "<p class='text-center'><a class='btn btn-primary' href='recursos.php'>Subir otro archivo</a></p>";
 ...
 //si la función is_uploaded_files devuelve false, se informa de que ha ocurrido un problema
  ...
  switch($_FILES['mifichero']['error']){
   case UPLOAD_ERR_OK: //no hay error, pero si no ha sido cargado puede ser un ataque
	 ...
	 echo "<p class='text-center'><a class='btn btn-primary' href='recursos.php'>Volver</a></p>";
     break;
